...
c.NotebookApp.certfile = u'{{ jupyter_notebook_certfile }}'
...
c.NotebookApp.keyfile = u'{{ jupyter_notebook_keyfile }}'
...
c.NotebookApp.password = u'{{ notebook_auth.stdout }}'
